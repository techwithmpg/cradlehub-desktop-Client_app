...
export const BookingInspectorCard: React.FC<BookingInspectorCardProps> = ({
  ...
  if (!booking) {
    return (
      <ModuleInspectorFrame isEmpty ariaLabel="Booking Inspector">
        <ModuleInspectorEmptyState
          title="No Booking Selected"
          description="Select a booking from the list to view its complete operational overview, customer profile, and lifecycle details."
        />
  ...
  return (
    <ModuleInspectorFrame ariaLabel="Booking Details Inspector">
      {/* 1. Header */}
